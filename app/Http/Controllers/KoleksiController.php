...
class KoleksiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'nomor_penyimpanan' => ['required', 'string', 'max:12'],
            'cara_perolehan' => ['required', 'string', 'max:30'],
            'kondisi_koleksi' => ['required', 'string', 'max:20'],
            'ciri_khusus' => ['nullable', 'string', 'max:50'],
            'nomor_seri' => ['nullable', 'string', 'max:12'],
            'bahan' => ['nullable', 'string', 'max:20'],
            'warna' => ['nullable', 'string', 'max:30'],
            'motif' => ['nullable', 'string', 'max:35'],
            'dekorasi' => ['nullable', 'string', 'max:30'],
            'teknik_pembuatan' => ['required', 'string', 'max:30'],
            'tempat_pembuatan' => ['nullable', 'string', 'max:30'],
            'fungsi' => ['nullable', 'string', 'max:30'],
            'tempat_penyimpanan' => ['required', 'string', 'max:25'],
            'keterangan' => ['nullable', 'string', 'max:255'],
            'judul_naskah' => ['nullable', 'string', 'max:50'],
            'ukuran_naskah' => ['nullable', 'string', 'max:35'],
            'jumlah_halaman' => ['nullable', 'string', 'max:20'],
            'jumlah_baris' => ['nullable', 'string', 'max:35'],
            'iluminasi' => ['nullable', 'string', 'max:30'],
            'jumlah_baris' => ['nullable', 'string', 'max:35'],
