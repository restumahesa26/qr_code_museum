...
class KoleksiController extends Controller
{
    ...
    {
        $request->validate([
            'nomor_inventaris' => ['required', 'numeric', 'unique:koleksis'],
            ...
            'nomor_penyimpanan' => ['required', 'numeric'],
            ...
            // 'jumlah_baris' => ['required', 'numeric'],
            // 'panjang_ukuran' => ['required', 'numeric'],
            // 'lebar_ukuran' => ['required', 'numeric'],
            // 'tinggi_ukuran' => ['required', 'numeric'],
            // 'tebal_ukuran' => ['required', 'numeric'],
            // 'diameter_ukuran' => ['required', 'numeric'],
            // 'panjang_badan' => ['required', 'numeric'],
            // 'lebar_badan' => ['required', 'numeric'],
            // 'tinggi_badan' => ['required', 'numeric'],
            // 'tebal_badan' => ['required', 'numeric'],
            // 'diameter_badan' => ['required', 'numeric'],
            // 'panjang_alas' => ['required', 'numeric'],
            // 'lebar_alas' => ['required', 'numeric'],
            // 'tinggi_alas' => ['required', 'numeric'],
            // 'tebal_alas' => ['required', 'numeric'],
            // 'diameter_alas' => ['required', 'numeric'],
            // 'panjang_mulut' => ['required', 'numeric'],
            // 'lebar_mulut' => ['required', 'numeric'],
            // 'tinggi_mulut' => ['required', 'numeric'],
            // 'tebal_mulut' => ['required', 'numeric'],
            // 'diameter_mulut' => ['required', 'numeric'],
            // 'tinggi_keseluruhan' => ['required', 'numeric'],
            // 'panjang_mata' => ['required', 'numeric'],
            // 'lebar_mata' => ['required', 'numeric'],
            // 'tinggi_mata' => ['required', 'numeric'],
            // 'tebal_mata' => ['required', 'numeric'],
            // 'diameter_mata' => ['required', 'numeric'],
            // 'panjang_tangkai' => ['required', 'numeric'],
            // 'lebar_tangkai' => ['required', 'numeric'],
            // 'tinggi_tangkai' => ['required', 'numeric'],
            // 'tebal_tangkai' => ['required', 'numeric'],
            // 'diameter_tangkai' => ['required', 'numeric'],
            // 'panjang_sarung' => ['required', 'numeric'],
            // 'lebar_sarung' => ['required', 'numeric'],
            // 'tinggi_sarung' => ['required', 'numeric'],
            // 'tebal_sarung' => ['required', 'numeric'],
            // 'diameter_sarung' => ['required', 'numeric'],
            // 'panjang_keseluruhan' => ['required', 'numeric'],
