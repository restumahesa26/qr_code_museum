...
<div class="section-header d-flex justify-content-start">
    <a href="{{ route('data-pengguna.index') }}" class="btn btn-info btn-sm mr-2">Kembali</a>
    <h1>Data Pengguna</h1>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" id="password_confirmation" name="password_confirmation" placeholder="Masukkan Konfirmasi Password" value="{{ old('password_confirmation') }}">
