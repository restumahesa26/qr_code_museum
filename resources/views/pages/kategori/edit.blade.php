            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('kode') is-invalid @enderror" id="kode" name="kode" placeholder="Masukkan Kode Kategori" value="{{ old('kode', $item->kode) }}" min="01" step="1" >
                        @error('kode')
