            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('kode') is-invalid @enderror" id="kode" name="kode" placeholder="Masukkan Kode Kategori" value="{{ old('kode') }}" min="01" step="1" >
                        @error('kode')
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto" name="foto" placeholder="Masukkan Foto Kategori" value="{{ old('foto') }}" onchange="preview_image();" required>
                        @error('foto')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
