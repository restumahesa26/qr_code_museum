...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4 justify-content-start table-responsive d-none d-md-block">
        ...
        <div class="row g-4 justify-content-start table-responsive d-md-none d-sm-block">
            <table class="table table-borderless">
                <tbody>
                    <tr>
